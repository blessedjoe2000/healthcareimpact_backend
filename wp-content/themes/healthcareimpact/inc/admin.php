...
add_action('customize_preview_init', function () {
    die("<h2>:warning: The customizer is disabled. Please save and preview your site on the frontend :warning:</h2>");
}, 1);
...
function add_featured_image_support() {
    add_theme_support('post-thumbnails', apply_filters('pagelines_post-thumbnails', array('post', 'artists')));
}
